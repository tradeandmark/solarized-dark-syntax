...
An atom theme using the ever popular dark [solarized](http://ethanschoonover.com/solarized) colors.
...
We haven't published this to the atom registry yet, so to install:

```bash
[sudo] apm install tradeandmark/trademark-dark-syntax
```
